...
export default function OnboardingPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#fff', background: '#0f0f14', minHeight: '100dvh' }}>
      <h1>SYNK 소개</h1>
      ...
      <button
        ...
        style={{ marginTop: 48, padding: '14px 32px', background: '#6c63ff', borderRadius: 12, color: '#fff', fontSize: 16 }}
      >
        시작하기
      </button>
    </div>
