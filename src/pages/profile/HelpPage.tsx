...
const FAQ: { q: string; a: string }[] = [
  {
    q: '미션 알림은 언제 오나요?',
    a: '방이 시작되는 첫날은 튜토리얼 미션이 진행돼요. 둘째 날부터는 방에 설정된 알림 시간대 안에서 랜덤한 시각에 미션이 발동돼요. 알림이 울리면 5분 안에 참여해야 기록으로 남아요.',
  },
  {
    q: '미션은 어떻게 제출하나요?',
    a: '알림이 오면 5분 안에 앱을 열어 카메라로 사진을 찍어 제출하면 돼요. 방 멤버 모두가 제출하면 하나의 콜라주로 완성돼요.',
  },
  {
    q: '푸시 알림이 오지 않아요.',
  ...
  {
    q: '방은 어떻게 시작되나요?',
    a: '방 인원이 다 차면(풀방) 인원이 찬 그 다음 날 자정부터 매일 그날의 미션이 자동으로 생성돼요. 인원이 차기 전까지는 대기 상태예요.',
  },
  {
    q: '미션을 놓치면 어떻게 되나요?',
  ...
  {
    q: 'Synklog가 뭔가요?',
    a: '방 안에서 완료된 콜라주들을 날짜별로 모아보는 공간이에요. 우리 방만의 기록 일지예요.',
  },
  {
    q: '프로필 사진은 어떻게 바꾸나요?',
