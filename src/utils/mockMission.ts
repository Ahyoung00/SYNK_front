...
export function createMockMission(secondsLeft = MISSION_DURATION_S): ActiveMissionState {
  return {
    ...
    participations: [
      { user: { id: 1, name: '유현', profile_image: undefined }, state: 'waiting' },
      { user: { id: 2, name: '아영', profile_image: undefined }, state: 'waiting' },
      { user: { id: 3, name: '지민', profile_image: undefined }, state: 'waiting' },
      { user: { id: 4, name: '수현', profile_image: undefined }, state: 'waiting' },
      { user: { id: 5, name: '대주', profile_image: undefined }, state: 'waiting' },
    ],
